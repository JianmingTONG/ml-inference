#!/usr/bin/env python3
"""Train the shallow (784-50-10, one square) HE-friendly MNIST MLP."""
...
from he_mlp_shallow import TrainShallowHEMLP, to_inference_model  # noqa: E402

HERE = os.path.dirname(os.path.abspath(__file__))
DEFAULT_OUT = os.path.join(HERE, 'he_mlp_shallow_weights.pth')
...
def main():
  ...
  model = TrainShallowHEMLP(args.hidden)
